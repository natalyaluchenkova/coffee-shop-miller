...
export const ProductCard = (props) => {
  ...
  return (
    <div className='productCard'>
        ...
        <div><img src={star} className='rateStars' alt='star' /></div><div ><a className='rateNumberCard' href='#!'><span className='rate'>4.0</span>(32 отзыва)</a></div>      
        <div className='anyProductImg'>
            <img
